...
try {
  //see if browser can use speech recognition
  ...
  console.error(e);
  $('#start-info').append('<p>Please note: Your current browser does not support voice searches</p>')
}
...
$('#speak').on('click', function(e) {
  if(recognition){
    ...
    alert('Voice search has been disabled on this browser!')
  }
});
